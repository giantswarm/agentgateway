...
| controller.image | object | `{"pullPolicy":"","registry":"gsoci.azurecr.io","repository":"giantswarm/agentgateway-controller","tag":""}` | Configure the controller container image. |
...
| controller.image.tag | string | `""` | Set the image tag for the controller. Empty falls back to .Chart.AppVersion, the vendored upstream release. |
