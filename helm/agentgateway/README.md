...
| controller.image | object | `{"pullPolicy":"","registry":"gsoci.azurecr.io","repository":"giantswarm/agentgateway-upstream/controller","tag":"2.1.2"}` | Configure the controller container image. |
...
| proxy | object | `{"image":{"registry":"gsoci.azurecr.io","repository":"giantswarm/agentgateway-upstream/agentgateway","tag":"2.1.2"}}` | Configure the agentgateway data plane deployment. |
...
| proxy.image.tag | string | `"2.1.2"` | Set the default image tag: the same release of the Giant Swarm line of agentgateway as the controller. renovate: datasource=docker depName=giantswarm/agentgateway-upstream/agentgateway registryUrl=https://gsoci.azurecr.io |
