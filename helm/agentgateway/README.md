...
| controller.image | object | `{"pullPolicy":"","registry":"gsoci.azurecr.io","repository":"giantswarm/agentgateway-controller","tag":"v1.5.1-gs.4"}` | Configure the controller container image. |
...
| proxy | object | `{"image":{"registry":"gsoci.azurecr.io","repository":"giantswarm/agentgateway","tag":"v1.5.1-gs.4"}}` | Configure the agentgateway data plane deployment. |
...
| proxy.image.tag | string | `"v1.5.1-gs.4"` | Set the default image tag: the same release of the Giant Swarm line of agentgateway as the controller. renovate: datasource=docker depName=giantswarm/agentgateway registryUrl=https://gsoci.azurecr.io |
